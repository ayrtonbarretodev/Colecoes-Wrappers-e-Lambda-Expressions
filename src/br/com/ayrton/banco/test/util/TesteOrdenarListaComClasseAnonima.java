...
public class TesteOrdenarListaComClasseAnonima {
    public static void main(String[] args) {
        ...
        // modo 1 - mais simplificado do que criar duas classes e implementar o Comparator (exemplos comentados abaixo)
